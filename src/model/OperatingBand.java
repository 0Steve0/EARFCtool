 ...
 * you can calculate the operatingband by earfcn
 * @author shaoliujia
 * @Time 2016-5-3
 *
 */
public class OperatingBand {
	...
	/**
	 * calculate the operating band 
	 * @param e
	 * which is a object and the return type is integer         
	 */
	public int calculateoperatingband(Earfcn e){
		int a=0;
		for(int i=0;i<list.size();)
		{
			if(list.get(i)<=e.getEarfcn()&&e.getEarfcn()<list.get(i+1))
			 a=i; break;
		}
